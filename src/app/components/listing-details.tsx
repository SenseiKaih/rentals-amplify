...
const center = {
  lat: 36.778259, // Replace with desired latitude
  lng: -119.417931 // Replace with desired longitude
};
    ...
    <div className="container mx-auto px-4 py-8">
      <Card className="overflow-hidden">
        <div className="relative h-64 w-full">
          <LoadScript googleMapsApiKey="AIzaSyAfq7rScMWfubv19THQExSn88NLVw-sTo4">
            <GoogleMap
